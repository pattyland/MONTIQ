...
**M**onitoring **T**elemetry **I**n **Q**ueue (MONTIQ) is a tiny Bash helper for Raspberry Pi and other headless Linux mini PCs. It publishes health metrics to MQTT and creates Home Assistant entities automatically via MQTT Discovery.
